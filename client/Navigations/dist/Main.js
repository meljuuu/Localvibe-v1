...
var OnBoarding_1 = require("../src/screens/OnBoarding");
...
var Main = function (props) {
    ...
    var checkIfAlreadyOnboarded = function () { return __awaiter(void 0, void 0, void 0, function () {
        var onBoarded;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, asyncStorage_1.getItem('onBoarded')];
                case 1:
                    onBoarded = _a.sent();
                    if (onBoarded === null) {
    ...
    if (showOnboarding) {
        return (react_1["default"].createElement(Stack.Navigator, { initialRouteName: "Onboarding", screenOptions: {
                headerShown: false
            } },
            react_1["default"].createElement(Stack.Screen, { name: "OnBoarding", component: OnBoarding_1["default"] }),
